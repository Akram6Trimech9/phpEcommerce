 ...
 <div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-container">
     ...
     <?php  if(isset($_GET['ajout']) && $_GET['ajout']== "ok") {
      print '        <div class="alert alert-success"> Category ajouter   </div>
      ';
        ...
        print '        <div class="alert alert-success"> Category Modifier   </div> ' ;}?>
  <br />
  <br />
   ...
   <?php 
      foreach ($categories as $category){ 
          ...
          <th scope="row">'.$category['ID'].'</th>
            ...
            <td>
              <a href="supprimer.php?idcat='.$category['ID'].' "  class="btn btn-danger">Supprimer</a>
              <button class="btn btn-warning modal-title" data-toggle="modal" data-target="#editmodal'.$category['ID'].'"  >modifier</button>
    ...
    <div class="modal-content">
      ...
      <form action="ajout.php" method="POST">
       <div class="form-group">
         <input name="nom" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nom de produit ">
      </div>
   <br />
  <div class="form-group">
...
<?php foreach($categories as $index => $category ){?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">  modifier une Category</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <form action="update.php" method="POST">
       ...
       <div class="form-group">
         <input name="nom" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php  echo $category['nom'] ?>" >
      </div>
   <br />
  <div class="form-group">
     <textarea name="description"   class="form-control" id="exampleInputPassword1" ><?php echo  $category['description'] ?></textarea>
  </div>
   <br />
